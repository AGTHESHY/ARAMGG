...
export const electronAPI: ElectronAPI = {
  ...
  penguPlugin: {
    ...
    getInjection: (...args) => requireElectronAPI().penguPlugin.getInjection(...args),
    enableInjection: (...args) => requireElectronAPI().penguPlugin.enableInjection(...args),
    disableInjection: (...args) => requireElectronAPI().penguPlugin.disableInjection(...args),
    getPlugins: (...args) => requireElectronAPI().penguPlugin.getPlugins(...args),
    togglePlugin: (...args) => requireElectronAPI().penguPlugin.togglePlugin(...args),
    getConfig: (...args) => requireElectronAPI().penguPlugin.getConfig(...args),
    setConfig: (...args) => requireElectronAPI().penguPlugin.setConfig(...args),
    detectLeague: (...args) => requireElectronAPI().penguPlugin.detectLeague(...args),
    restartClient: (...args) => requireElectronAPI().penguPlugin.restartClient(...args),
  },
  lcu: {
