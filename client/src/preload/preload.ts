...
const electronAPI: ElectronAPI = {
  ...
  penguPlugin: {
    ...
    getInjection: () => ipcRenderer.invoke('pengu-plugin-get-injection'),
    enableInjection: () => ipcRenderer.invoke('pengu-plugin-enable-injection'),
    disableInjection: () => ipcRenderer.invoke('pengu-plugin-disable-injection'),
    getPlugins: () => ipcRenderer.invoke('pengu-plugin-get-plugins'),
    togglePlugin: (hash) => ipcRenderer.invoke('pengu-plugin-toggle', hash),
    getConfig: () => ipcRenderer.invoke('pengu-plugin-get-config'),
    setConfig: (section, key, value) => ipcRenderer.invoke('pengu-plugin-set-config', section, key, value),
    detectLeague: () => ipcRenderer.invoke('pengu-plugin-detect-league'),
    restartClient: () => ipcRenderer.invoke('pengu-plugin-restart-client'),
  },
  lcu: {
